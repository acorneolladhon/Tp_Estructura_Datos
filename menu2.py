from bal2 import Balneario
from bal2 import chequear_flotante
import pickle
        ...
        if choice=="3":
            ...
            if continuar==True:
                    ...
                    while comenzar2==True:
                        ...
                        7-Visualizar disponibilidad de carpas
                        8-Ver clientes adeudados
                        9-Salir: """)
                                ...
                                if metodo_eleccion.lower().strip()!="f" and metodo_eleccion.lower().strip()!="a":
                                    ...
                                    if dias.isdigit():
                                        try:
                                            ...
                                            reserva_realizada=balneario.asignar_reserva(tipo_reserva,metodo_eleccion,int(dias), int(dni_trabajado),precio)
                                            balneario.ver_matriz(tipo_reserva)
                                        except ValueError as e:
                                            print("Error!", e)
                                    else:
